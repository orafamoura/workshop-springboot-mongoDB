...
public class UserResource {
	...
	public ResponseEntity<UserDTO> delete(@PathVariable String id){ // responseEntity do spring
	...
	public ResponseEntity<List<Post>> findPosts(@PathVariable String id){ // responseEntity do spring
